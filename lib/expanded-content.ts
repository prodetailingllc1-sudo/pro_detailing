...
export const additionalServices: readonly ExtendedService[] = [
  ...
  },
  {
    ...
    media: [
      ...
      {
        src: '/generated/auto-glass-technician-windshield-v2.webp',
        alt: 'Clearly visible auto-glass technician using professional suction-cup tools to position a windshield in a dark service studio.',
        eyebrow: 'Professional glass handling',
        title: 'See the technician, tools and glass together.',
        copy: 'Controlled handling, correct fitment, clean bonding surfaces and the approved installation process are confirmed before the vehicle is returned.',
      },
    ],
